...
//  VulkanEngine
//
//  Created by Gabriele Padovani on 22/01/22.
//

#ifndef EngineDescriptor_h
#define EngineDescriptor_h
 ...
 public:
  class Builder {
   ...
   private:
    ...
    EngineDescriptorSetLayout(EngineDevice &lveDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings);
 ...
 public:
  class Builder {
   ...
   private:
    ...
    EngineDescriptorPool( EngineDevice &device, uint32_t maxSets, VkDescriptorPoolCreateFlags poolFlags, const std::vector<VkDescriptorPoolSize> &poolSizes);
